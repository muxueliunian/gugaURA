...
type Il2cppDomainGetAssemblies =
    extern "C" fn(domain: *mut Il2CppDomain, size: *mut usize) -> *mut *mut c_void;
...
type Il2cppClassFromName = extern "C" fn(
    image: *const Il2CppImage,
    namespace: *const i8,
    name: *const i8,
) -> *mut Il2CppClass;
type Il2cppClassGetMethodFromName =
    extern "C" fn(klass: *mut Il2CppClass, name: *const i8, args_count: i32) -> *const MethodInfo;
...
pub fn init() {
    ...
    unsafe {
        ...
        IL2CPP_CLASS_GET_METHOD_FROM_NAME = Some(std::mem::transmute(dlsym(
...
pub fn get_assembly_image(assembly_name: &str) -> Option<*const Il2CppImage> {
    unsafe {
        ...
        error!(
            "Assembly '{}' not found in {} loaded assemblies",
            assembly_name, size
        );
        None
    }
